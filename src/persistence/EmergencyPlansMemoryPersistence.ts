...
export class EmergencyPlansMemoryPersistence 
    extends IdentifiableMemoryPersistence<EmergencyPlanV1, string> 
    implements IEmergencyPlansPersistence {
    ...
    private matchSearch(item: EmergencyPlanV1, search: string): boolean {
